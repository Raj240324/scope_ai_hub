    ...
    <div className="container-custom">
      <div className="bg-[var(--bg-inverted)] rounded-2xl md:rounded-[3rem] p-6 sm:p-10 md:p-16 text-[var(--text-on-inverted)] text-center relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h2 className="heading-md sm:heading-hero text-[var(--text-on-inverted)]">Confused About Your <span className="text-primary">Career Path</span>?</h2>
          <p className="text-body sm:text-xl text-[var(--text-on-inverted)]/80 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button
              ...
              className="bg-primary text-white font-bold px-6 sm:px-10 py-4 sm:py-5 rounded-2xl hover:opacity-90 transition-all flex items-center shadow-xl text-body sm:text-lg group w-full sm:w-auto justify-center"
            >
            ...
            <div className="text-left hidden sm:flex items-center space-x-4 bg-primary/10 px-6 py-3 rounded-xl border border-primary/20 backdrop-blur-sm">
              ...
              <div>
                <p className="text-caption font-bold uppercase tracking-widest text-[var(--text-on-inverted)]/60">Available Now</p>
                <p className="text-caption font-bold text-[var(--text-on-inverted)]">3 Counselors Online</p>
              </div>
            </div>
          </div>
        </div>
