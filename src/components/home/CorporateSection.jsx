  ...
  <section className="py-20 dark-section text-white">
    ...
    <div className="container-custom relative z-10">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <div className="inline-flex glass-card items-center space-x-2 px-3 py-1 rounded-full text-white text-caption font-bold uppercase tracking-wider mb-6">
            For Organizations
          </div>
          <h2 className="heading-lg font-bold text-white mb-6 leading-tight">
            Empower Your Workforce with <span className="font-extrabold text-primary">Corporate Training</span>
          </h2>
          <p className="text-body md:text-lg text-white/70 mb-10 leading-relaxed">
            ...
            {[
              ...
              <div key={i} className="space-y-2">
                <h4 className="font-bold text-white flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-white/80 mr-2" />
                  {item.title}
                </h4>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              ...
              <div className="glass-card h-64 flex flex-col items-center justify-center p-8 text-center">
                <div className="heading-md font-bold text-white mb-2">25+</div>
                <div className="text-small font-bold uppercase tracking-widest text-white/70">Organisations Trained</div>
              </div>
            </div>
            <div className="space-y-4 pt-12">
              <div className="glass-card h-64 flex flex-col items-center justify-center p-8 text-center">
                <div className="heading-md font-bold text-white mb-2">500+</div>
                <div className="text-small font-bold uppercase tracking-widest text-white/70">Professionals Upskilled</div>
              </div>
              <div className="glass-card h-48 flex items-center justify-center p-8">
