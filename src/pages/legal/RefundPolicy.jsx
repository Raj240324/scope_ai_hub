      ...
      <div className="container-custom section-padding">
        <div className="max-w-4xl mx-auto prose prose-slate prose-lg">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 mb-4">The following fees are strictly non-refundable under any circumstances:</p>
              ...
              <table className="min-w-full border-collapse border border-slate-200 text-sm">
                <thead>
                  <tr className="bg-slate-50">
                    <th className="border border-slate-200 px-4 py-2 text-left">Request Timeline</th>
                    <th className="border border-slate-200 px-4 py-2 text-left">Refund Percentage</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-slate-200 px-4 py-2">7+ days before batch starts</td>
                    <td className="border border-slate-200 px-4 py-2">100% of Tuition Fee (minus registration)</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 px-4 py-2">Less than 7 days before batch starts</td>
                    <td className="border border-slate-200 px-4 py-2">50% of Tuition Fee</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 px-4 py-2">After batch has commenced</td>
                    <td className="border border-slate-200 px-4 py-2">Strictly No Refund</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 mt-4">Approved refunds will be processed within 15-20 working days via the original payment method.</p>
          </section>
