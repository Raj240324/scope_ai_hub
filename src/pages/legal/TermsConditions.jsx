    ...
    <Layout>
      ...
      <div className="container-custom section-padding">
        <div className="max-w-4xl mx-auto prose prose-slate prose-lg">
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">2. Admission & Fees</h2>
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">3. Academic Policies</h2>
            <ul className="list-disc pl-6 text-[var(--text-muted)] space-y-2">
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">4. Code of Conduct</h2>
            <p className="text-[var(--text-muted)] mb-4">
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">6. Intellectual Property</h2>
            <p className="text-[var(--text-muted)] mb-4">
          ...
          <section>
            <h2 className="heading-md mb-4">8. Governing Law & Contact</h2>
            <p className="text-[var(--text-muted)] mb-4">
