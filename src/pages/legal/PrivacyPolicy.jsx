    ...
    <Layout>
      ...
      <div className="container-custom section-padding">
        <div className="max-w-4xl mx-auto prose prose-slate prose-lg">
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">3. Utilization of Data</h2>
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">4. Data Sharing & Third Parties</h2>
            <p className="text-[var(--text-muted)] mb-4">
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">5. Student Rights</h2>
            <p className="text-[var(--text-muted)] mb-4">
          ...
          <section className="mb-12">
            <h2 className="heading-md mb-4">6. Media & Testimonials</h2>
            <p className="text-[var(--text-muted)] mb-4">
          ...
          <section>
            <h2 className="heading-md mb-4">7. Contact & Grievance Officer</h2>
