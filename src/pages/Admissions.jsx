...
const Admissions = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Enrollment",
      description: "Complete the registration process and secure your seat. Contact us for fee structure details."
    },
    {
  ...
  const batches = [
    { name: 'Weekday Batch', time: '10:00 AM - 1:00 PM', days: 'Mon - Fri', status: 'Filling Fast' },
    { name: 'Evening Batch', time: '6:30 PM - 8:30 PM', days: 'Mon - Fri', status: 'Available' },
    { name: 'Weekend Batch', time: '10:00 AM - 4:00 PM', days: 'Sat - Sun', status: 'Available' },
  ];
      ...
      <div className="container-custom section-padding">
        ...
        <div className="mt-24 p-8 md:p-12 bg-slate-900 text-white rounded-3xl relative overflow-hidden text-center">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto mb-10 relative z-10">
            We believe in honest pricing. Our course fees are competitive and reflect the quality of training provided. We offer flexible installment options to make education accessible.
          </p>
